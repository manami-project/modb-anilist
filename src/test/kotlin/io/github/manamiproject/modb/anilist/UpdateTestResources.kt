...
fun main() {
    ...
    downloader.download("100081").writeToFile(resourceFile("file_converter_tests/anime_season/season_is_null_and_start_date_is_2020.json"))
    ...
    downloader.download("105191").writeToFile(resourceFile("file_converter_tests/duration/0.json"))
    ...
    downloader.download("235").writeToFile(resourceFile("file_converter_tests/episodes/null.json"))
    ...
    downloader.download("109125").writeToFile(resourceFile("file_converter_tests/picture_and_thumbnail/picture_unavailable.json"))
    ...
    downloader.download("101777").writeToFile(resourceFile("file_converter_tests/status/null.json"))
    downloader.download("105191").writeToFile(resourceFile("file_converter_tests/status/releasing.json"))
    ...
    downloader.download("10323").writeToFile(resourceFile("file_converter_tests/type/null.json"))
    ...
    downloader.download("98635").writeToFile(resourceFile("file_converter_tests/type/special.json"))
    ...
    downloader.download("20954").writeToFile(resourceFile("file_converter_tests/type/unknown.json"))
}
